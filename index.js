...
class Car {
  constructor(model, milesPerGallon) {
    ...
    drive (distance) {
      const distancePot = this.tank * this.milesPerGallon;
        if (distance <= distancePot) {
          this.odometer = distance + this.odometer;
          this.tank = this.tank - (distance / this.milesPerGallon)
        } else {
          this.odometer = this.odometer + distancePot;
          this.tank = 0;
...
class Instructor extends Lambdasian {
  constructor (atte) {
    super (atte);
    this.specialty = atte.specialty;
    this.favLanguage = atte.favLanguage;
    this.catchPhrase = atte.catchPhrase;
  }
    demo (subject) {
